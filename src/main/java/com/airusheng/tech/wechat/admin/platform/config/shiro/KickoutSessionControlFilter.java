...
/**
 * ClassName		:	KickoutSessionControlFilter <br/>
 * Function			:	限制并发人数登陆. <br/>
 * Date				:	2018年7月17日 下午6:41:51 <br/>
 *
 * @author			:	Alex Hu
 * @version			:	1.0.0
 * @since			:	JDK 1.8
...
public class KickoutSessionControlFilter extends AccessControlFilter {
	...
	protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
		...
		String accountCode = loginInfo.getSysAccountInfo().getAccountCode();
		Serializable sessionId = session.getId(); 

		//读取缓存   没有就存入
		Deque<Serializable> deque = cache.get(accountCode);
