...
@Table(name = "sys_account_role_info")
public class SysAccountRoleInfo implements Serializable {
    /**
     * 主键，使用UUID生成唯一值
     */
    @Id
    ...
    public void setAccountRowId(String accountRowId) {
        this.accountRowId = accountRowId == null ? null : accountRowId.trim();
    }

    /**
     * 获取角色主键
     *
     * @return role_row_id - 角色主键
     */
    ...
    public boolean equals(Object that) {
        ...
        SysAccountRoleInfo other = (SysAccountRoleInfo) that;
        return (this.getRowId() == null ? other.getRowId() == null : this.getRowId().equals(other.getRowId()))
            && (this.getAccountRowId() == null ? other.getAccountRowId() == null : this.getAccountRowId().equals(other.getAccountRowId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAccountRowId() == null) ? 0 : getAccountRowId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", accountRowId=").append(accountRowId);
